...
class PaymentNoOtpController extends Controller
{
    ...
    private function render_error_html(string $title, string $reason, string $errorCode, string $bookingCode): string
    {
        return '<!DOCTYPE html>'
            ...
            . '<br>'
            . '<a href="' . e(env('FRONTEND_URL', 'https://viajerosbo.up.railway.app')) . '" style="display:inline-block;margin-top:10px;padding:10px 25px;background:#555;color:#fff;border-radius:6px;text-decoration:none;font-size:14px;">Volver al Inicio</a>'
            . '</div></body></html>';
    }
